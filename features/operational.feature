...
# documented opt-out — never the default. The output pipeline lives in
# output.feature and run observability in observability.feature (both Phase 1);
# the remaining Phase-3.5 items (retry/error classification, CAPTCHA detection,
# change detection) are authored here when their turn comes.
#
